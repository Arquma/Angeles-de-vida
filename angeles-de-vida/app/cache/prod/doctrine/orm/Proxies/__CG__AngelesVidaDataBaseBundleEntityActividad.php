 ...
 */
class Actividad extends \AngelesVida\DataBaseBundle\Entity\Actividad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Actividad' . "\0" . 'id', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Actividad' . "\0" . 'nombre', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Actividad' . "\0" . 'fecha', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Actividad' . "\0" . 'horaInicio', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Actividad' . "\0" . 'horaFin', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Actividad' . "\0" . 'descripcion', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Actividad' . "\0" . 'lugar');
        }
