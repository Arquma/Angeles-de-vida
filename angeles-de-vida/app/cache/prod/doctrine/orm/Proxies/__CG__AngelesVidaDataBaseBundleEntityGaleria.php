 ...
 */
class Galeria extends \AngelesVida\DataBaseBundle\Entity\Galeria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Galeria' . "\0" . 'id', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Galeria' . "\0" . 'imagen', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Galeria' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Galeria $proxy) {
