 ...
 */
class Usuario extends \AngelesVida\DataBaseBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Usuario' . "\0" . 'nombreUsuario', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Usuario' . "\0" . 'contrasena');
        }
