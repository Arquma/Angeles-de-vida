 ...
 */
class Protocolo extends \AngelesVida\DataBaseBundle\Entity\Protocolo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Protocolo' . "\0" . 'id', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Protocolo' . "\0" . 'nombre', '' . "\0" . 'AngelesVida\\DataBaseBundle\\Entity\\Protocolo' . "\0" . 'descripcion');
        }
